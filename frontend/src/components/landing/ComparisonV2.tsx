...
const TOOLS: Tool[] = [
  ...
  { key: "bolt", name: "Bolt.new", icon: "⚡", iconColor: "text-yellow-400" },
...
const ROWS: Row[] = [
  {
    ...
    cells: {
      ...
      bolt: { status: "yes", text: "Sí, buena calidad" },
  ...
  },
  {
    ...
    cells: {
      ...
      bolt: { status: "warn", text: "Puede ser confuso" },
  ...
  },
  {
    ...
    cells: {
      ...
      bolt: { status: "yes", text: "Sí, en el editor" },
  ...
  },
  {
    ...
    cells: {
      ...
      bolt: { status: "no", text: "No, un solo modelo" },
  ...
  },
  {
    ...
    cells: {
      ...
      bolt: { status: "no", text: "No, solo prototipo" },
  ...
  },
  {
    ...
    cells: {
      ...
      bolt: { status: "yes", text: "Sí, sin registro" },
  ...
  },
  {
    ...
    cells: {
      ...
      bolt: { status: "warn", text: "Más para devs" },

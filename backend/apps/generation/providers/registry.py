...
MODEL_REGISTRY = {
    ...
    # thinking + output_config.effort, no budget_tokens. Sonnet 5 (Low) is the
    # default model (see DEFAULT_MODEL) and available to all plans.
...
# Default model
DEFAULT_MODEL = "claude-sonnet-5-low"
